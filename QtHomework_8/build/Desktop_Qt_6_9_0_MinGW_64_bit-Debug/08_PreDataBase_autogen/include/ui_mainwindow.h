...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(pb_request, 4, 2, 1, 1);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, lb_category);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, cb_category);


        gridLayout->addWidget(gb_filters, 1, 2, 1, 1);
        ...
        tb_result = new QTableView(centralwidget);
